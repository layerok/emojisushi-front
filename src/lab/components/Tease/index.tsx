...
export const Tease = ({ children }) => {
  return Children.map(children, (child) => {
    return <RunAway>{child}</RunAway>;
  });
};

const RunAway = ({ children }) => {
  useLayoutEffect(() => {
    const onScroll = (e) => {
    ...
    <div
      ...
      onMouseMove={(e) => {
        ...
        ref.current.style.top =
          clientY -
          +ref.current.dataset.cachedTop -
          +ref.current.dataset.entryY +
          "px";
        ref.current.style.left =
          clientX -
          +ref.current.dataset.cachedLeft -
          +ref.current.dataset.entryX +
          "px";
      }}
    >
      {children}
